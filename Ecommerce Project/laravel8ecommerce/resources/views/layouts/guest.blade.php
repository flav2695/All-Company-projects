...
<!-- First comment guest.blade.php entire code and copy all base.blade.php code and paste it in guest.blade.php under comment section. -->
<!DOCTYPE html>
<html lang="en">
<head>
	<meta charset="utf-8">
...
<body class="home-page home-01 ">
	...
	<header id="header" class="header header-style-1">
                                    ...
                                    @auth <!-- If user is authenticated/authorised -->
                                        ...
                                        <!-- Admin -->
                                            <li class="menu-item menu-item-has-children parent" >
                                                ...
                                                <ul class="submenu curency" >     
                                                    <li class="menu-item" >
                                                         <a title="Dashboard" href="{{ route('admin.dashboard') }}"> Admin Dashboard</a> <!--Remove # and add {{ route('admin.dashboard') }} -->
                                                    </li>
													<!-- Logout for Admin -->
													<li class="menu-item" >
                                        ...
                                        <!-- User -->  
                                            <li class="menu-item menu-item-has-children parent" >
                                                ...
                                                <ul class="submenu curency" >     
                                                    <li class="menu-item" >
                                                        <a title="Dashboard" href="{{ route('user.dashboard') }}">User Dashboard</a> <!--Remove # and add {{ route('user.dashboard') }} -->
                                                    </li>
                                                    <!-- Logout for User-->
													<li class="menu-item" >
						...
						<div class="container">
							<ul class="nav primary clone-main-menu" id="mercado_main" data-menuname="Main menu" >
								<li class="menu-item home-icon">
									<a href="/" class="link-term mercado-item-title"><i class="fa fa-home" aria-hidden="true"></i></a> <!-- remove index.html from href and add / -->
								</li>
								<li class="menu-item">
									<a href="about-us.html" class="link-term mercado-item-title">About Us</a>
								</li>
								<li class="menu-item">
									<a href="/shop" class="link-term mercado-item-title">Shop</a> <!--remove shop.html from href and add /shop-->
								</li>
								<li class="menu-item">
									<a href="/cart" class="link-term mercado-item-title">Cart</a> <!--remove shop.html from href and add /cart-->
								</li>
								<li class="menu-item">
									<a href="/checkout" class="link-term mercado-item-title">Checkout</a> <!--remove shop.html from href and add /checkout-->
								</li>
								<li class="menu-item">
	 ...
	 {{$slot}} <!--Removed main tag and added $slot -->
